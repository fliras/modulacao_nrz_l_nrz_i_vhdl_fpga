# Modulação NRZ-L
Implementação em VHDL da modulação Unipolar NRZ-IL, em que o bit é representado pelo nivel
do pulso durante todo o intervalo do bit (1 = nivel alto, 0 = nivel baixo).
...
- `sim/tb_modulador_nrzl.vhd` - testbench para simulação
...
1. Abrir o Vivado e carregar `vivado_project/modulador_nrzl.xpr` (extraia o zip do projeto antes)
